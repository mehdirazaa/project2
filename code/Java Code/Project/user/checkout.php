...
if(isset($_POST['isubmit']))
{
    ...
    Email.send({
        ...
        Body: '<?php echo "Order ID : ".$order_id."  Address : ".$address."  City : ".$city."  Pincode : ".$pincode."  Total Amount : ".$total_amount."  Payment Type : ".$payment_type."  Order Date : ".$added_on; ?>'
    }).then(window.alert('Order details has been mailed to you... Thank You'));
